...
function buildCompanyProfile(info, keyRow, rng) {
  ...
  return {
    ...
    "تشكيل المنظومة": `المشغّلون: ${pickOne(["سائق + قائد + رامي", "قائد + مشغّل رادار + مشغّل أسلحة", "قائد + ملاحظ أمامي + طاقم تحميل"], rng)}. تعمل ضمن ${pickOne(["سرية", "فصيلة", "كتيبة"], rng)} من ${4 + Math.floor(rng() * 12)} وحدة.`,
